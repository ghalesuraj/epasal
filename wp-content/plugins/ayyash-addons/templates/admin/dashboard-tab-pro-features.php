...
?>
	<div class="ayyash-addons-settings-panel pro-features">
		<div class="ayyash-addons-settings-panel__body">
			<div class="pro-left-content">
				<img src="<?php ayyash_addons_plugin_url( 'assets/images/logo2.png' );?>" alt="<?php esc_attr_e( 'Logo', 'ayyash-addons' ); ?>">
				<h2><?php esc_html_e( 'Get Pro and Experience all those existing great features and widgets.', 'ayyash-addons'); ?></h2>
				<a href="https://wpayyash.com/wordpress-plugins/absolute-addons/pricing/?utm_source=plugin-dashboard&utm_medium=pro-features&utm_campaign=get-pro&utm_content=get-pro" class="button"><?php esc_html_e( 'Get Pro Now', 'ayyash-addons' ); ?></a>
			</div>
			<div class="pro-right-content">
				<div class="pro-features-content">
					...
					<div class="pro-features-title">
						<h3><?php esc_html_e( 'Pro Features', 'ayyash-addons');?></h3>
						<p><?php esc_html_e( 'Why upgrade to Pro version?', 'ayyash-addons');?></p>
					</div>
				</div>
				...
				<div class="pro-video-content">
					...
					<div class="pro-video-item">
						...
						<div class="pro-text">
							<h3><?php esc_html_e( 'All Pro Widget', 'ayyash-addons');?></h3>
							<p><?php esc_html_e( 'We have 16 free and 5 pro widgets and 100s are coming on continuous updates which you can enjoy when you will buy our pro plugins. So all widgets and layout you can use under pro plan.', 'ayyash-addons');?></p>
						</div>
					</div>
					<div class="pro-video-item">
						<div class="pro-icon">
						...
						<div class="pro-text">
							<h3><?php esc_html_e( 'All Pro Features', 'ayyash-addons');?></h3>
							<p><?php esc_html_e( 'We are planned for weekly 2 updates and a major updates after 4 updates. We are coming with a lot of features and functionality which will be available only for pro member of our plugin.', 'ayyash-addons');?></p>
						</div>
					</div>
				</div>
			</div>
