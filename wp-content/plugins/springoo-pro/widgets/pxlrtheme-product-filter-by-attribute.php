...
class WC_Widget_Layered_Nav extends WC_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a list of attributes to filter products in your store.', 'springoo-pro' );
		$this->widget_id          = 'woocommerce_layered_nav';
		$this->widget_name        = __( 'Filter Products by Attribute', 'springoo-pro' );
		parent::__construct();
	}
	...
	public function init_settings() {
		...
		$this->settings = array(
			'title' => array(
				'type'  => 'text',
				'std'   => __( 'Filter by', 'springoo-pro' ),
				'label' => __( 'Title', 'springoo-pro' ),
			),
			'attribute' => array(
				'type'    => 'select',
				'std'     => '',
				'label'   => __( 'Attribute', 'springoo-pro' ),
				'options' => $attribute_array,
			),
			'display_type' => array(
				'type'    => 'select',
				'std'     => 'list',
				'label'   => __( 'Display type', 'springoo-pro' ),
				'options' => array(
					'list'     => __( 'List', 'springoo-pro' ),
					'dropdown' => __( 'Dropdown', 'springoo-pro' ),
				),
			),
			'query_type' => array(
				'type'    => 'select',
				'std'     => 'and',
				'label'   => __( 'Query type', 'springoo-pro' ),
				'options' => array(
					'and' => __( 'AND', 'springoo-pro' ),
					'or'  => __( 'OR', 'springoo-pro' ),
				),
			),
		);
	}
	...
	protected function layered_nav_dropdown( $terms, $taxonomy, $query_type ) {
		...
		if ( $taxonomy !== $this->get_current_taxonomy() ) {
			...
			if ( $multiple ) {
				echo '<button class="woocommerce-widget-layered-nav-dropdown__submit" type="submit" value="' . esc_attr__( 'Apply', 'springoo-pro' ) . '">' . esc_html__( 'Apply', 'springoo-pro' ) . '</button>';
			}
				...
				if ( jQuery().selectWoo ) {
					var wc_layered_nav_select = function() {
						jQuery( '.dropdown_layered_nav_" . esc_js( $taxonomy_filter_name ) . "' ).selectWoo( {
							...
							language: {
								noResults: function() {
									return '" . esc_js( _x( 'No matches found', 'enhanced select', 'springoo-pro' ) ) . "';
								}
							}
						} );
					};
