...
.container {
		...
		<div class="qcwrap">
			...
			<table class="form-table">
				<tbody>
					...
					<tr valign="top">
						<th scope="row"><?php echo esc_html('Intent');?></th>
						<td>	
    ...
    <a href="<?php echo add_query_arg( 'action', 'edit', admin_url('admin.php?page=simple-text-response') ); ?>" class="page-title-action"><?php echo esc_html('Add New' ); ?></a>

	<?php if(class_exists('Qcld_str_pro')): ?>
	
	<a href="<?php echo add_query_arg( 'action', 'manage-categories', admin_url('admin.php?page=simple-text-response') ); ?>" class="page-title-action"><?php echo esc_html('Manage Categories' ); ?></a>
	<a href="<?php echo add_query_arg( 'action', 'manage-entities', admin_url('admin.php?page=simple-text-response') ); ?>" class="page-title-action"><?php echo esc_html('Manage Entities' ); ?></a>
	<a href="<?php echo admin_url( 'admin-post.php?action=qc_str_export' ); ?>" class="page-title-action"><?php echo esc_html('Export');?></a>
	<a href="<?php echo add_query_arg( 'action', 'import', admin_url('admin.php?page=simple-text-response') ); ?>" class="page-title-action"><?php echo esc_html('Import' ); ?></a>
    
	<?php endif; ?>
	
	<hr class="wp-header-end">
	
    <p><?php echo esc_html('Create simple text responses and the ChatBot will use advanced search algorithm for natural language phrase matching with user input.' ); ?></p>
    <p><b><?php echo esc_html('This is a new feature. If you have any feedback to improve this feature or found a bug please report us');?> <a href="https://www.quantumcloud.com/resources/free-support/" target="_blank"><?php echo esc_html('here' ); ?></a>.</b></p>
	<p><b><?php echo esc_html('NB: Simple Text Responses require mySQL Client version 5.6+');?></b></p>

    <form method="post" action="">
		<table class="form-table">
			<tbody>
				<tr valign="top">
					<th scope="row"><?php echo esc_html('Phrase matching accuracy');?></th>
					<td>
						...
						<br><i><?php echo esc_html('Please enter a value between 0 to 1. Higher value means more exact matching of phrases.');?></i>
					</td>
				</tr>
				
				<tr valign="top">
					<th scope="row"><?php echo esc_html('Search Fields');?></th>
					<td>
						<?php 
							$fields = get_option('qc_bot_str_fields');
						?>
					
						<label for="qc_bot_str_field_title"><?php echo esc_html('Title');?></label>
						...
						<label for="qc_bot_str_field_keyword"><?php echo esc_html('Keyword');?></label>
						...
						<label for="qc_bot_str_field_response"><?php echo esc_html('Response');?></label>
						...
						<br><i><?php echo esc_html('Please check/uncheck to allow/disallow searching in that fields');?></i>
					</td>
				</tr>
				<?php if(class_exists('Qcld_str_pro')): ?>
				<tr valign="top">
					<th scope="row"><?php echo esc_html('Remove Stopwords');?></th>
					<td>
						...
						<label for="qc_bot_str_remove_stopwords"><?php echo esc_html('Remove Stopwords' ); ?></label>
						<br><i><?php echo esc_html('Please enable to remove stopwords from users query for better searching.');?></i>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row"><?php echo esc_html('Allow Shortcodes');?></th>
					<td>
						...
						<label for="qc_bot_str_allow_shortcode"><?php echo esc_html('Allow shortcodes');?></label>
						<br><i><?php echo esc_html('Please enable to allow shortcode in response field.');?></i>
					</td>
				</tr>
				<tr valign="top">
					<th scope="row"><label for="qc_bot_str_max_limit"><?php echo esc_html('Maximum number of matching STR responses to show (Ex. 3)');?></label></th>
					<td>
						<input type="text" name="qc_bot_str_max_limit" value="<?php echo (get_option('qc_bot_str_max_limit')!=''?get_option('qc_bot_str_max_limit'):'3'); ?>" style="width: 400px;" required />
					</td>
				</tr>
				<?php endif; ?>
				<tr valign="top">
	...
	<table class="form-table">
		<tbody>
			<tr valign="top">
				<th scope="row"><?php echo esc_html('Re-Index STR Simple Text Responses');?></th>
				<td>
					<input type="submit" class="button button-primary" name="qc-re-index" id="re-index" value="Re Index">
					<br/>
					<i><?php echo esc_html('Re-Indexing may required after migration.');?></i>
				</td>
			</tr>
		</tbody>
	</table>
    ...
    <div class="qc_bot_floating_content"> <img alt="Launch the chatbot for testing" src="<?php echo esc_url(QCLD_wpCHATBOT_IMG_URL.'/icon-0.png'); ?>" alt="WPBot"><p><?php echo esc_html('Test Your Changes');?></p> </div>
</div>
<div id="wpbot-qcbot-myModal" class="wpbot-giphy-modal" style="z-index: 99999;padding-top: 0;">
    <?php $page = get_page_by_title_two('wpwBot Mobile App'); ?>
    <!-- Modal content -->
    ...
    <?php echo esc_html('To test in the front end, after making any changes, please type reset and hit enter in the ChatBot to start testing from the beginning or open a new Incognito window (Ctrl+Shit+N in Chrome).');?>
