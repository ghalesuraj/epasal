 ...
 * @since 1.1.0
 */
class AyyashAddons_Style_Woocommerce_Product_Slider_V3 extends Ayyash_Pro_Widget {
	...
	public function get_name() {
		return 'ayyash-woocommerce-product-slider-v3';
	}
	...
	public function get_title() {
		return __( 'Woocommerce Product Slider V3', 'ayyash-addons-pro' );
	}
	...
	public function get_icon() {
		return 'ayyash-addons eicon-media-carousel';
	}
	...
	public function get_style_depends() {
		return [
			'ayyash-bootstrap',
			'ayyash-addons-pro-woocommerce-product-slider-v3',
		];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-products.ayyash-addons-column ' => 'grid-template-columns: repeat({{VALUE}},1fr);',
				],
			]
		);
		$this->add_control(
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-products.has-grid-gap' => 'gap: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'woocommerce_product_column_gap_custom' => 'custom_gap',
				],
			]
		);
		$this->add_control(
		...
		$this->add_control(
			'woocommerce_product_enable_labels',
			[
				'label'        => esc_html__( 'Product Enable Label?', 'ayyash-addons-pro' ),
				'type'         => Controls_Manager::SWITCHER,
				'return_value' => 'yes',
				'default'      => 'yes',
				'separator'    => 'before',
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-cart-btn .ayyash-addons-btn, .ayyash-cart-btn .added_to_cart' => 'width: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
					'enable_add_to_cart' => 'yes',
				],
		...
		$this->start_controls_section(
			'wc_product_labels',
			[
				'label'     => esc_html__( 'Labels ', 'ayyash-addons-pro' ),
				'tab'       => Controls_Manager::TAB_CONTENT,
				'condition' => [
					'woocommerce_product_enable_labels' => 'yes',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default'     => '%',
				'condition'   => [
					'woocommerce_product_discount_label' => 'yes',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .product-labels' => 'top: {{SIZE}}{{UNIT}};',
				],
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .product-labels' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->start_controls_section(
			'wc_product_price',
			[
				'label'     => esc_html__( 'Actions', 'ayyash-addons-pro' ),
				'tab'       => Controls_Manager::TAB_CONTENT,
				'condition' => [
		...
		if ( ayyash_addons_is_plugin_active( 'yith-woocommerce-wishlist/init.php' ) || ayyash_addons_is_plugin_active( 'yith-woocommerce-quick-view/init.php' ) ) {
			...
			$this->add_control(
				...
				[
					...
					'selectors'  => [
						'{{WRAPPER}} .product-actions.bottom' => 'bottom: {{SIZE}}{{UNIT}};',
					],
			...
			$this->add_control(
				...
				[
					...
					'selectors'  => [
						'{{WRAPPER}} .product-actions.right' => 'top: {{SIZE}}{{UNIT}};',
					],
			...
			$this->add_control(
				...
				[
					...
					'selectors'  => [
						'{{WRAPPER}} .product-actions.right' => 'right: {{SIZE}}{{UNIT}};',
					],
					'condition'  => [ 'actions_position' => 'right' ],
				]
			);
	...
	protected function __product_add_to_cart_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-btn, {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn .ayyash-addons-btn, {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn .added_to_cart',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn .ayyash-addons-btn' => 'fill: {{VALUE}}; color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn .added_to_cart'     => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn .ayyash-addons-btn, {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn .added_to_cart',
				'fields_options' => [
					'background' => [
						'default' => 'classic',
					],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}  .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-cart-btn  .ayyash-addons-btn:focus'                           => 'color: {{VALUE}};',
					'{{WRAPPER}}  .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn  .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-cart-btn  .ayyash-addons-btn:focus'         => 'color: {{VALUE}};',
					'{{WRAPPER}}  .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn  .added_to_cart:hover, {{WRAPPER}} .ayyash-cart-btn  added_to_cart:focus'                  => 'color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn   .ayyash-addons-btn:hover svg, {{WRAPPER}} .ayyash-addons-btn:focus svg'                   => 'fill: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn  .ayyash-addons-btn:hover svg, {{WRAPPER}}  .ayyash-cart-btn  .ayyash-addons-btn:focus svg' => 'fill: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-cart-btn  .added_to_cart:hover svg, {{WRAPPER}}  .ayyash-cart-btn  .added_to_cart:focus svg'         => 'fill: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'types'          => [ 'classic', 'gradient' ],
				'exclude'        => [ 'image' ], // phpcs:ignore WordPressVIPMinimum.Performance.WPQueryParams.PostNotIn_exclude
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-cart-btn .ayyash-addons-btn:focus, {{WRAPPER}} .ayyash-cart-btn .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-cart-btn .added_to_cart:hover',
				'fields_options' => [
					'background' => [
						'default' => 'classic',
					],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-addons-btn:focus' => 'border-color: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-btn , {{WRAPPER}} .ayyash-cart-btn .ayyash-addons-btn, {{WRAPPER}} .ayyash-cart-btn .added_to_cart',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	...
	protected function __product_body_style() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-products.no-gap .ayyash-addons-product-item .ayyash-addons-product-item-inner' => 'border-color: {{VALUE}} !important; ',
				],
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-item-inner',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-item-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-item:hover .ayyash-addons-product-item-inner',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'          => esc_html__( 'Border', 'ayyash-addons-pro' ),
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-item:hover .ayyash-addons-product-item-inner, {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-item:focus-within .ayyash-addons-product-item-inner',
				'fields_options' => [
					'border' =>
						[
							'default' => 'none',
	...
	protected function __product_category_style() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-category a' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-category a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-category' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function __product_label_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-discount',
			]
		);
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-discount' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-discount' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-discount' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-discount' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-featured',
			]
		);
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-featured' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-featured' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-featured' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-featured' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
	...
	protected function __product_price_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-price .woocommerce-Price-amount bdi,
						{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-price ins .woocommerce-Price-amount bdi
						',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'
			{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-price .woocommerce-Price-amount bdi,
			{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-price ins .woocommerce-Price-amount bdi
            ' => 'color: {{VALUE}};',
				],
			]
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-price del .woocommerce-Price-amount bdi',
			]
		);
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-price del .woocommerce-Price-amount bdi' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-price' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function __product_rating_style() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-rating .star-rating span:before' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-rating' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-rating',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-rating' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function __product_thumbnail() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-thumbnail',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-thumbnail' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'      => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-thumbnail' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-thumbnail:hover',
			]
		);
	...
	protected function __product_title() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 h3.ayyash-addons-heading-title a' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 h3.ayyash-addons-heading-title a',
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 h3.ayyash-addons-heading-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 h3.ayyash-addons-heading-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function __product_stock() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock ',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock.in-stock'        => 'color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock.in-stock:before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock.out-of-stock'        => 'color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock.out-of-stock:before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock.on-back-order'        => 'color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock.on-back-order:before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .stock:before' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function __product_hover_actions() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist a i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button a i' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Border', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist,
				 				   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button,
								   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:hover,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:focus-within,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button:hover,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button:focus-visible,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button:focus-within,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button:hover' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:hover a i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:focus-within a i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button:hover i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button:focus-visible i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button:focus-within a i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button:hover a i' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Border', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:hover,
								{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:focus-within,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button:hover,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button:focus-visible,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button:focus-within,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3.product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:hover,
									{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:focus-visible,
				 				   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button:hover,
				 				   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .yith-wcqv-button:focus-visible,
				 				   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button:focus-visible,
								   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .product-actions.ayyash-addons-rounded .compare-button:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			'tooltip_height',
			[
				'label'      => esc_html__( 'Tooltip Height', 'ayyash-addons-pro' ),
				'type'       => Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range'      => [
					'px' => [
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-item .ayyash-tooltip'                                    => 'height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-item .product-actions .yith-wcwl-add-to-wishlist a span' => 'height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v3 .ayyash-addons-product-item .themeoo-tooltip'                                   => 'height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}',
				],
			]
		);
	...
	protected function render() {
		...
		$this->add_render_attribute( [
			...
			'ayyash_addons_slider_wrapper' => [
				'class' => 'ayyash-addons-swiper-wrapper ayyash-addons-products ' . $swiper_class,
			],
	...
	protected function init_hooks() {
		add_action( 'ayyash_addons_woocommerce_products', [
			$this,
			'render_products_template',
		] );
		add_action( 'ayyash_addons_single_product_summary', [
			$this,
			'ayyash_addons_single_product_header',
		], 10, 2 );
		add_action( 'ayyash_addons_single_product_summary', [
			$this,
			'ayyash_addons_single_product_content',
		], 10, 2 );
		add_action( 'ayyash_addons_single_product_summary', [
			$this,
			'ayyash_addons_single_product_footer',
		], 10, 2 );

		//header hooks
		add_action( 'ayyash_addons_single_product_header', [
			$this,
		...
		add_action( 'ayyash_addons_single_product_content', [
			$this,
		...
		add_action( 'ayyash_addons_single_product_content', [
			$this,
			'render_product_stock_text',
		], 25, 2 );

		//Actions hooks

		add_action( 'ayyash_addons_single_product_actions', [
			$this,
			'render_wishlist',
		], 15, 2 );
		add_action( 'ayyash_addons_single_product_actions', [
			$this,
			'render_quick_view_button',
		], 20, 2 );
		add_action( 'ayyash_addons_single_product_actions', [
			$this,
		...
		add_filter( 'yith_woocompare_main_script_localize_array', [
			$this,
			'ayyash_yith_woocompare_localize_array',
		] );
		...
		if ( isset( $settings['product_rating_position'] ) ) {
			...
			add_action( $position_hook, [
				$this,
				'render_product_rating',
			], 15, 2 );
		}
	...
	protected function removed_hooks() {
		remove_action( 'ayyash_addons_woocommerce_products', [
			$this,
			'render_products_template',
		] );
		remove_action( 'ayyash_addons_single_product_summary', [
			$this,
			'ayyash_addons_single_product_header',
		] );
		remove_action( 'ayyash_addons_single_product_summary', [
		...
		//header hooks
		remove_action( 'ayyash_addons_single_product_header', [
			$this,
			'render_product_image',
		] );
		remove_action( 'ayyash_addons_single_product_header', [
		...
		//content hooks
		remove_action( 'ayyash_addons_single_product_content', [
			$this,
			'render_product_stock_text',
		], 25 );
		remove_action( 'ayyash_addons_single_product_content', [
		...
		//Actions hooks
		remove_action( 'ayyash_addons_single_product_actions', [
			$this,
			'render_wishlist',
		], 15 );
		remove_action( 'ayyash_addons_single_product_actions', [
	...
	public function render_wishlist() {
		...
		if ( isset( $settings['enable_wishlist'] ) && 'yes' === $settings['enable_wishlist'] && 'yes' === $enable_wishlist ) {
			if ( ayyash_addons_is_plugin_active( 'yith-woocommerce-wishlist/init.php' ) ) {
				...
				if ( $this->wishlist_remove_label ) {
					add_filter( 'yith_wcwl_remove_from_wishlist_label', [
						$this,
				...
				remove_filter( 'yith_wcwl_remove_from_wishlist_label', [
					$this,
					'yith_wcwl_remove_from_wishlist_label',
				] );
			}
	...
	public function render_product_image( $post_id, $settings ) {
		...
		$gallery_class            = ( ! empty( $attachment_ids ) ) ? 'ayyash-addons-product-gallery' : '';
		?>

		<div class="product-thumbnail <?php echo esc_attr( $gallery_class ); ?>">
			<?php
			if ( empty( $attachment_ids ) ) {
				if ( 'yes' == $settings['woocommerce_product_image_link'] ) { ?>
				...
				<div id="<?php echo esc_attr( $uid ) ?>" class="carousel slide" data-bs-ride="false" data-bs-interval="false" data-bs-touch="true">
					<div class="carousel-inner">
						...
						<?php foreach ( $attachment_ids as $attachment_id ) {   $no_slides++; ?>
							<div class="carousel-item ">
								<a href="<?php echo esc_url( get_the_permalink() ) ?>"><img
										src="<?php echo esc_url( wp_get_attachment_image_url( $attachment_id, $settings['wc_product_thumbnail_size_size'] ) ); ?>"
										alt="<?php echo esc_attr( $product->get_name() ) ?>"></a>
							</div>
						<?php } ?>
					</div>
					<button class="carousel-control-prev" type="button" data-bs-target="#<?php echo esc_attr( $uid ) ?>"
							data-bs-slide="prev">
						<svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M6.5752 1.40034L1.14186 6.83368C0.500194 7.47534 0.500194 8.52534 1.14186 9.16701L6.5752 14.6003" stroke="#222222" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
						<span class="visually-hidden">Previous</span>
					</button>
					<button class="carousel-control-next" type="button" data-bs-target="#<?php echo esc_attr( $uid ) ?>"
							data-bs-slide="next">
						<svg width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path d="M1.4248 14.5997L6.85814 9.16632C7.49981 8.52466 7.49981 7.47466 6.85814 6.83299L1.4248 1.39966" stroke="#222222" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
						</svg>
	...
	public function render_product_get_quote_btn() {
		if ( class_exists( 'WPB_Get_Quote_Button' ) ) {
			...
			if ( 'on' === $loop_show ) {
				...
				remove_action( apply_filters( 'wpb_gqb_woo_loop_position', 'woocommerce_after_shop_loop_item' ), array( $this, 'woo_add_contact_form_button' ), apply_filters( 'wpb_gqb_woo_loop_priority', $loop_position ) );
