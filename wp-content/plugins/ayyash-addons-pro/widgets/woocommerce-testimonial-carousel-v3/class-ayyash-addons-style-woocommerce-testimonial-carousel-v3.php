 ...
 * @since 1.1.0
 */
class AyyashAddons_Style_Woocommerce_Testimonial_Carousel_V3 extends Ayyash_Pro_Widget {
	...
	public function get_name() {
		return 'ayyash-woocommerce-testimonial-carousel-v3';
	}
	...
	public function get_title() {
		return __( 'Testimonial V3', 'ayyash-addons-pro' );
	}
	...
	public function get_style_depends() {
		return array(
			'ayyash-addons-pro-woocommerce-testimonial-carousel-v3',
		);
	}
			...
			[
				...
				'default'     => [
					[
						...
						'testimonial_desc' => __( 'The shipping was surprisingly fast, and I was pleasantly surprised by how well-packaged the poster was. ', 'ayyash-addons-pro' ),
					],
					[
						'testimonial_name' => __( 'Rima Ford', 'ayyash-addons-pro' ),
						'testimonial_desc' => __( 'Great company, amazing posters, and product. The customer service is very responsive to any issues happy with his room now.', 'ayyash-addons-pro' ),
					],
				],
	...
	protected function __thumbnail() {
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash_testimonial_image_wrap' => 'gap: {{SIZE}}{{UNIT}};',
				],
			]
		);
	}
	...
	protected function render_image_header() {
		?> <div class="ayyash_testimonial_image_wrap"> <?php
	}

	protected function render_image_footer() {
		?> </div> <?php
	}

	protected function render_image_content_header() {
		?> <div class="ayyash_testimonial_image_content"> <?php
	}

	protected function render_image_content_footer() {
		?> </div> <?php
	}
