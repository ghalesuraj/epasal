 ...
 * @since 1.1.0
 */
class AyyashAddons_Style_Woocommerce_Product_Slider_V2 extends Ayyash_Pro_Widget {
	...
	public function get_name() {
		return 'ayyash-woocommerce-product-slider-v2';
	}
	...
	public function get_title() {
		return __( 'Woocommerce Product Slider V2', 'ayyash-addons-pro' );
	}
	...
	public function get_style_depends() {
		return [
			'ayyash-addons-pro-woocommerce-product-slider-v2',
		];
	}
	...
	protected function register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-products.has-grid-gap' => 'gap: {{SIZE}}{{UNIT}};',
				],
				'condition'  => [
	...
	protected function __product_add_to_cart_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-btn, {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn .ayyash-addons-btn, {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn .added_to_cart',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn .ayyash-addons-btn' => 'fill: {{VALUE}}; color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn .added_to_cart'     => 'fill: {{VALUE}}; color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn .ayyash-addons-btn, {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn .added_to_cart',
				'fields_options' => [
					'background' => [
						'default' => 'classic',
					],
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}}  .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-cart-btn  .ayyash-addons-btn:focus'                           => 'color: {{VALUE}};',
					'{{WRAPPER}}  .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn  .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-cart-btn  .ayyash-addons-btn:focus'         => 'color: {{VALUE}};',
					'{{WRAPPER}}  .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn  .added_to_cart:hover, {{WRAPPER}} .ayyash-cart-btn  added_to_cart:focus'                  => 'color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn   .ayyash-addons-btn:hover svg, {{WRAPPER}} .ayyash-addons-btn:focus svg'                   => 'fill: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn  .ayyash-addons-btn:hover svg, {{WRAPPER}}  .ayyash-cart-btn  .ayyash-addons-btn:focus svg' => 'fill: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-cart-btn  .added_to_cart:hover svg, {{WRAPPER}}  .ayyash-cart-btn  .added_to_cart:focus svg'         => 'fill: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'types'          => [ 'classic', 'gradient' ],
				'exclude'        => [ 'image' ], // phpcs:ignore WordPressVIPMinimum.Performance.WPQueryParams.PostNotIn_exclude
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-cart-btn .ayyash-addons-btn:focus, {{WRAPPER}} .ayyash-cart-btn .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-cart-btn .added_to_cart:hover',
				'fields_options' => [
					'background' => [
						'default' => 'classic',
					],
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-btn:hover, {{WRAPPER}} .ayyash-addons-btn:focus' => 'border-color: {{VALUE}};',
		...
		$this->add_group_control(
			...
			[
				...
				'selector'  => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-btn , {{WRAPPER}} .ayyash-cart-btn .ayyash-addons-btn, {{WRAPPER}} .ayyash-cart-btn .added_to_cart',
				'separator' => 'before',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
	...
	protected function __product_body_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-item-inner',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-item-inner' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-item:hover .ayyash-addons-product-item-inner',
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'          => esc_html__( 'Border', 'ayyash-addons-pro' ),
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-item:hover .ayyash-addons-product-item-inner, {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-item:focus-within .ayyash-addons-product-item-inner',
				'fields_options' => [
					'border' =>
						[
							'default' => 'none',
	...
	protected function __product_category_style() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-category a' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-category a',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-category' => 'margin-bottom: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function __product_label_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-discount',
			]
		);
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-discount' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-discount' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-discount' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-discount' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-featured',
			]
		);
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-featured' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-featured' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-featured' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-featured' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_tab();
	...
	protected function __product_price_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-price .woocommerce-Price-amount bdi,
						{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-price ins .woocommerce-Price-amount bdi
						',
			]
		);
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'
			{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-price .woocommerce-Price-amount bdi,
			{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-price ins .woocommerce-Price-amount bdi
            ' => 'color: {{VALUE}};',
				],
			]
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Typography', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-price del .woocommerce-Price-amount bdi',
			]
		);
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-price del .woocommerce-Price-amount bdi' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-price' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		$this->end_controls_section();
	...
	protected function __product_rating_style() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-rating .star-rating span:before' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-rating' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-rating',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-rating' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function __product_thumbnail() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-thumbnail',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'size_units' => [ 'px', '%', 'em' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-thumbnail' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'      => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-thumbnail' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector'       => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-thumbnail:hover',
			]
		);
	...
	protected function __product_title() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 h3.ayyash-addons-heading-title a' => 'color: {{VALUE}};',
				],
			]
		);
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 h3.ayyash-addons-heading-title a',
			]
		);
		$this->end_controls_tab();
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 h3.ayyash-addons-heading-title a:hover' => 'color: {{VALUE}};',
				],
			]
		);
		$this->end_controls_tab();
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', 'rem' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 h3.ayyash-addons-heading-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
	...
	protected function __product_stock() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock ',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock.in-stock'        => 'color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock.in-stock:before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock.out-of-stock'        => 'color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock.out-of-stock:before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock.on-back-order'        => 'color: {{VALUE}};',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock.on-back-order:before' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
				'separator'  => 'before',
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .stock:before' => 'left: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function __product_hover_actions() {
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist a i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button a i' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Border', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist,
				 				   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button,
								   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:hover,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:focus-within,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button:hover,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button:focus-visible,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button:focus-within,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button:hover' => 'background: {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:hover a i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:focus-within a i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button:hover i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button:focus-visible i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button:focus-within a i,
					{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button:hover a i' => 'color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'label'    => esc_html__( 'Border', 'ayyash-addons-pro' ),
				'selector' => '{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:hover,
								{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:focus-within,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button:hover,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button:focus-visible,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button:focus-within,
							   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button:hover',
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2.product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:hover,
									{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcwl-add-to-wishlist:focus-visible,
				 				   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button:hover,
				 				   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .yith-wcqv-button:focus-visible,
				 				   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button:focus-visible,
								   {{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .product-actions.ayyash-addons-rounded .compare-button:hover' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors'  => [
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-item .ayyash-tooltip' => 'height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-item .product-actions .yith-wcwl-add-to-wishlist a span' => 'height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .ayyash-addons-woocommerce-product-slider-v2 .ayyash-addons-product-item .themeoo-tooltip' => 'height: {{SIZE}}{{UNIT}}; line-height: {{SIZE}}{{UNIT}}',
				],
			]
		);
