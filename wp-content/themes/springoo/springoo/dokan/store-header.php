...
$store_open_notice        = isset( $store_info['dokan_store_open_notice'] ) && ! empty( $store_info['dokan_store_open_notice'] ) ? $store_info['dokan_store_open_notice'] : __( 'Store Open', 'springoo' );
$store_closed_notice      = isset( $store_info['dokan_store_close_notice'] ) && ! empty( $store_info['dokan_store_close_notice'] ) ? $store_info['dokan_store_close_notice'] : __( 'Store Closed', 'springoo' );
...
<div class="dokan-profile-frame-wrapper">
	<div class="profile-frame<?php echo esc_attr( $no_banner_class ); ?>">
		...
		<div class="profile-info-box profile-layout-<?php echo esc_attr( $profile_layout ); ?>">
			<div class="info-box-banner-wrap">
						...
						<ul class="dokan-store-info">
							...
							<?php if ( ! dokan_is_vendor_info_hidden( 'email' ) && ! empty( $store_user->get_email() ) ) { ?>
								<li class="dokan-store-email">
									<a href="mailto:<?php echo esc_html( $store_user->get_email() ); ?>"><?php echo esc_html( $store_user->get_email() ); ?></a>
								</li>
							<?php } ?>
									...
									<div class="store-open-close-notice">
										...
										dokan_get_template_part(
											...
											[
												...
												'times_heading' => __( 'Weekly Store Timing', 'springoo' ),
												'closed_status' => __( 'CLOSED', 'springoo' ),
											]
										);
										?>
									</div>
